...
deflookup_train_exact(src_sent, src_lang_c, tgt_lang_c):
"""
...
defsmt_generate_n_best(smt_model, s, src_lang, tgt_lang, n_best=6):
"""
...
defpostprocess_target(text: str, tgt_lang: str) -> str:
"""
